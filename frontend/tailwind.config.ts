  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "brutal-primary": "4px 4px 0px hsl(54, 100%, 50%)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "scale-in": "scale-in 0.2s linear forwards",
        "slide-in-left": "slide-in-left 0.2s linear",
        "count-up": "count-up 0.3s linear forwards",
      },
    },
  },
